...
#define LabelCreate(x, y, text, scale) \
	(Label) { x, y, 0, 0, label_update, text, scale }
...
#define ImageCreate(x, y, w, h, s_x, s_y, s_w, s_h) \
	(Image) { s_x, s_y, s_w, s_h, image_update, x, y, w, h }
...
#define ButtonCreate(x, y, w, h, cb, s_x, s_y, s_w, s_h) \
	(Button) { s_x, s_y, s_w, s_h, button_update, x, y, w, h, cb, false }
...
#define TButtonCreate(x, y, w, h, cb, pointer, reverse, s_x, s_y, s_w, s_h) \
	(ToggleButton) { s_x, s_y, s_w, s_h, tbutton_update, x, y, w, h, cb, false, reverse, pointer }
...
#define PlayerListCreate(x, y) \
	(PlayerList) { x, y, 144, 176, playerlist_update, false, { 0 } }
